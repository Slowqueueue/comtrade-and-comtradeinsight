...
public struct Ticks : IComparable, IFormattable, IConvertible, IComparable<Ticks>, IComparable<long>, IComparable<DateTime>, IComparable<TimeSpan>, IEquatable<Ticks>, IEquatable<long>, IEquatable<DateTime>, IEquatable<TimeSpan>
{
    ...
    /// </summary>
    public const long PerMillisecond = 10000L;

    /// <summary>
    /// Number of 100-nanosecond ticks in one microsecond.
    /// </summary>
    public const long PerMicrosecond = 10L;
    ...
    /// s represents a number less than <see cref="MinValue"/> or greater than <see cref="MaxValue"/>.
    /// </exception>
    ...
    /// is not of the correct format, or represents a number less than <see cref="MinValue"/> or greater than <see cref="MaxValue"/>.
    ...
    /// When this method returns, contains the <see cref="Ticks"/> value equivalent to the number contained in s,
    /// if the conversion succeeded, or zero if the conversion failed. The conversion fails if the s parameter is null,
    /// is not in a format compliant with style, or represents a number less than <see cref="MinValue"/> or
    /// greater than <see cref="MaxValue"/>. This parameter is passed uninitialized.
    /// </param>
    /// <param name="provider">
    ...
    ///     <item>
    ///         <term>Seconds</term>
    ///         <description><see cref="PerSecond"/></description>
    ///     </item>
    ///     <item>
    ///         <term>Milliseconds</term>
    ///         <description><see cref="PerMillisecond"/></description>
    ///     </item>
    ///     <item>
    ///         <term>Microseconds</term>
    ///         <description><see cref="PerMicrosecond"/></description>
    ///     </item>
    ///     <item>
    ///         <term>Ticks</term>
    ...
    /// <summary>
    /// Returns the distribution timestamp for given <paramref name="timestamp"/> or <see cref="MinValue"/> if there is no TS within the specified Tolerance.
    /// </summary>
    /// <param name="timestamp">Timestamp to align.</param>
    /// <param name="samplesPerSecond">Samples per second to use for distribution.</param>
    /// <param name="tolerance">Tolerance of the TS in ticks.</param>
    /// <param name="baseline"> Starting Timestamp of the Distribution.</param>
    /// <returns>The distribution timestamp for given <paramref name="timestamp"/>or <see cref="MinValue"/> .</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
